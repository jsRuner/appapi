...
$dw = intval($_GET['width']);
$dh = intval($_GET['height']);
$w = $dw;
$h = $dh;

$thumbfile = 'image/'.lib_app_helper_attach::makethumbpath($daid, $dw, $dh);$attachurl = lib_app_helper_attach::attachpreurl();
if(!$nocache) {
